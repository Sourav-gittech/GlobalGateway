...
import NoticeSection from "../../../../Components/user/apply-visa/payment/payment-review/NoticeSection";
import PaymentReviewDropdown from "../../../../Components/user/apply-visa/payment/payment-review/PaymentReviewDropdown";
import PaymentSummaryCard from "../../../../Components/user/apply-visa/payment/payment-review/PaymentSummaryCard";
import TrustBadges from "../../../../Components/user/apply-visa/payment/payment-review/TrustBadges";
...
const PaymentPreview = () => {
  ...
  const handleBack = () => {
    ...
    navigate(`/application-form/${state?.country_id}`);
  };
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-3 pt-2 pb-4">
              ...
              >
                ...
                <span>Pay ₹{Number(state?.paymentDetails?.total_amount)?.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>

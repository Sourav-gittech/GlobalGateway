      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-gray-200">
          ...
          <select
            ...
            className="w-full sm:w-auto px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-700 text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
          >
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 sm:p-6 shadow-sm">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Country-wise Revenue Comparison</h2>
          <p className="text-sm text-gray-600 mb-6">Revenue generated from different countries</p>
          <ResponsiveContainer width="100%" height={320}>
            <BarChart data={countryData} layout="vertical">
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(37, 83, 176, 1)" />
              <XAxis type="number" stroke="rgba(32, 96, 190, 1)" style={{ fontSize: '12px' }} />
              <YAxis dataKey="country" type="category" stroke="rgba(46, 95, 194, 1)" style={{ fontSize: '11px' }} width={80} />
              <Tooltip 
              ...
              >
                <defs>
                  <linearGradient id="barGradient" x1="0" y1="0" x2="1" y2="0">
                    <stop offset="0%" stopColor="hsla(53, 93%, 45%, 1.00)" />
                    <stop offset="100%" stopColor="hsla(52, 89%, 46%, 1.00)" />
                  </linearGradient>
                </defs>
              </Bar>
            </BarChart>

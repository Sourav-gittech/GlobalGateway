...
const CartDrawer = ({ cartItems, setCartItems,setCartDrawer }) => {
            ...
            <div className="fixed right-0 top-0 h-full w-full sm:w-[480px] bg-white/95 backdrop-blur-xl shadow-2xl transform transition-transform duration-300 flex flex-col border-l border-white/20">
                ...
                {cartItems.length > 0 && (
                    <div className="border-t border-gray-200 bg-white/80 backdrop-blur-sm px-6 py-5">
                        ...
                        <button onClick={() => navigate('/cart')} className="w-full bg-gradient-to-r from-[#FF5252] to-[#E63946] hover:from-[#E63946] hover:to-[#FF5252] text-white font-semibold py-4 rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl mb-3 transform hover:scale-105">

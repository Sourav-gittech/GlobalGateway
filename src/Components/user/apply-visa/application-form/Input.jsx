      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            ref={ref} // <-- IMPORTANT
            {...rest}
            {...(register ? register(id) : {})} // <-- MUST COME LAST
            className={`
              w-full 
              ${Icon ? "pl-11" : "pl-4"} 
              ...
              ${
                hasError
                  ? "border-red-300 bg-red-50/50 focus:border-red-500 focus:ring-4 focus:ring-red-100 shadow-sm"
                  : isValid
        ...
        {hasError && (
          <div
            id={`${id}-error`}
            className="flex items-center gap-1.5 mt-2 text-sm text-red-600 animate-slideDown"
          >

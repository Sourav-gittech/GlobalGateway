...
//                     className={`text-sm font-medium flex items-center gap-1 ${fields.length >= 5 ? 'text-gray-400 cursor-not-allowed' : 'text-blue-600 hover:text-blue-700'}`}>
//                     <Plus className='inline h-4 mb-1' /> Add Document
//                 </button>
//             </div>
//             <div className="space-y-2">
...
//             </div>
//             {fields.length >= 5 && (
//                 <p className="text-xs text-gray-500 mt-1">Maximum of 5 documents allowed.</p>
//             )}
//         </div>
//     )
// }

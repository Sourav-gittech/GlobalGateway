...
const StatsGrid = ({ visaPolicy, currentCountryVisaTypes, specificVisaEnableCountry }) => {
    ...
    const stats = [
        { id: 1, title: 'Total Countries', subTitle: 'Visa enable countries', count: specificVisaEnableCountry?.length, icon: CheckCircle, iconColor: 'text-blue-600', subtitleColor: 'text-gray-500' },

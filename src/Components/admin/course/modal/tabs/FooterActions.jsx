...
export default function FooterActions({ onClose, isEdit }) {
    ...
    return (
        <div className="flex items-center justify-end gap-3 pt-6 border-t border-slate-700/50 mt-6">
            <button type="button" onClick={onClose} className="px-6 py-2.5 bg-slate-700/50 hover:bg-slate-700 border border-slate-600/50 text-slate-300 rounded-lg text-sm font-medium transition-colors cursor-pointer">
                Cancel
            </button>

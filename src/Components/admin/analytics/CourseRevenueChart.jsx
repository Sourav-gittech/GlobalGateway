...
// Revenue data - Visa Immigration Courses (in Indian Rupees)
const revenueData = [
  { name: 'Student Visa Preparation', value: 3750000, color: '#5B8FF9' },
  { name: 'Work Visa Application', value: 3200000, color: '#5AD8A6' },
  { name: 'Tourist Visa Processing', value: 2100000, color: '#F6BD16' },
  { name: 'Business Visa Consultation', value: 1200000, color: '#9270CA' },
  { name: 'Permanent Residency Program', value: 1375000, color: '#FF6B6B' }
];
...
export default function CourseRevenueChart() {
  ...
  return (
    <div 
      className={`rounded-lg p-6 border border-gray-700/50 transition-all duration-700 ${

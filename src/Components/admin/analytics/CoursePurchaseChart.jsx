...
// Course purchase data - Visa Immigration Courses
const coursePurchaseData = [
  { name: 'Student Visa Preparation', value: 450, color: '#5B8FF9' },
  { name: 'Work Visa Application', value: 320, color: '#5AD8A6' },
  { name: 'Tourist Visa Processing', value: 280, color: '#F6BD16' },
  { name: 'Business Visa Consultation', value: 180, color: '#9270CA' },
  { name: 'Permanent Residency Program', value: 150, color: '#FF6B6B' }
];

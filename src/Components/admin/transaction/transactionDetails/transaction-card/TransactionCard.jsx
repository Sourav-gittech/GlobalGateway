        ...
        <div className="p-4 hover:bg-slate-700/20 transition-colors">
            <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                    <div className="text-sm font-medium text-white mb-1">{txn.id}</div>
                    <div className="text-xs text-slate-400 mb-2">{txn.reference}</div>
                    <div className="text-sm text-white font-medium mb-1">{txn.applicant}</div>
